...
const ComboInternationalPack = () => {
  ...
  const handleAdd = () => {
    console.log('planName', editPlanName);
    console.log('Plan Price', editPrice);
  ...
  useEffect(() => {
    const getService = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`${server}/api/comboInternationPackService/plans`);
  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await axios.put(`${server}/api/comboInternationPackService/update/${editId}`, requestData, {
        headers: {
          Accept: '*/*',
...
export default ComboInternationalPack;
