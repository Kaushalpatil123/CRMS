...
async function handleSubmit(e){
  ...
  try {
    const response = await axios.put(`${server}/api/internationalresumeservice/update/${serviceKey}/${editId}`,requestData, {
      headers: {
        Accept: '*/*',
        ...
        <Grid item xs={12}>
          ...
          <List sx={{ width: 1, p: 0 }}>
            ...
            >
              ...
              <ListItemText
                primary={<Typography variant="h4" className='text-orange-600 w-[70%]'>Text International Resume Services</Typography>}
