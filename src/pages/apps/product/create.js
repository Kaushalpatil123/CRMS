...
import { AddCategory, AddProduct, AddSubcategory, fetchCategories } from 'pages/utils/products/api';
...
const Create = () => {
  ...
  return (
    <div className="">
      <h3 className="text-2xl font-semibold text-gray-900 mb-4">Enter Item</h3>
      {/* <div className="flex justify-between py-6">
       
      </div> */}
      {/* <hr className="h-[1px] bg-gray-300 my-4" /> */}
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-4 flex-grow overflow-auto pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 py-2">
          <div>
        ...
        <div className="flex gap-4 mb-4">
          <div className="w-[50%]">
            ...
            <div className="flex items-center">
              <select
                id="category"
                className="border border-gray-300 rounded-md p-2 w-full focus:outline-none  h-[45px]" // Added z-10 for proper layering
              ...
              <button
                type="button"
                className="ml-2 bg-[#779E40] hover:bg-[#5F7E33] hover:text-white text-white px-4 py-2 rounded-sm  h-[45px]"
