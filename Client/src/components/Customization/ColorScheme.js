...
const ColorScheme = () => {
  ...
  const colorOptions = [
    {
      id: 'default',
      primary: mode === ThemeMode.DARK ? 'red' : 'blue',
      darker: mode === ThemeMode.DARK ? 'green' : 'yellow'
    },
    {
      id: 'theme1',
      primary: mode === ThemeMode.DARK ? 'red' : 'yellow',
      darker: mode === ThemeMode.DARK ? 'blue' : 'green'
    },
    {
      id: 'theme2',
