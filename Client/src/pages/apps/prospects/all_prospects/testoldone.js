...
//       // setLeadsId(lead?._id); // Save the ID to state
...
//       // setInteractionArr(lead?.lastInteractions);
//       // seteditNextAction(lead?.nextInteraction?.description);
...
//       console.log('lead mobile--->', prospect?.data);
...
//                         onClick={() => navigate(`/apps/lead/details/${prospect._id}`)}
//                       >
...
//                         <TableCell className="font-poppins text-center">{prospect?.samplegiven}</TableCell>
//                         <TableCell className="font-poppins text-center">{prospect?.discussion}</TableCell>
//                         <TableCell className="font-poppins text-center">{prospect?.discussion}</TableCell>
//                         <TableCell className="font-poppins text-center">{prospect?.discussion}</TableCell>
...
//                           <Chip
//                             label={prospect.status !== undefined ? prospect.status : 'N/A'}
//                             sx={{
//                               backgroundColor: prospect.status !== undefined ? getStatusColor(prospect.status) : 'grey',
//                               color: 'white',
//                               padding: '0px 0.5px',
//                               fontSize: '12px',
//                               fontWeight: 450,
  ...
  <TableRow
    ...
    sx={{
      ...
      '& td': {
        borderBottom: 'none',
        borderRight: 'none',
        padding: '8px' // Ensure body cells have consistent padding
      }
    }}
  >
    <TableCell padding="checkbox">
    ...
    <TableCell className="text-center">{row?.new ? 'Yes' : 'No'}</TableCell>
    <TableCell className="text-center">
      {/* <Box display="flex" alignItems="center"> */}
      <TableCell className="text-center">{row?.discussion ? 'Yes' : 'No'}</TableCell>
      {/* </Box> */}
    </TableCell>
    <TableCell className="text-center">{row?.sampleGiven ? 'Yes' : 'No'}</TableCell>

    <TableCell className="text-center">{row?.firstName}&nbsp;{row?.lastName}</TableCell>
    <TableCell className="text-center">
      <Chip
        label={row?.prospectStage}
        sx={{
          backgroundColor: row.status === 'Closed' ? '#4caf50' : '#f44336',
          color: '#ffffff',
          fontWeight: 'bold',
          fontSize: '0.75rem',
          borderRadius: '12px'
    ...
    <TableCell className="text-center">{row?.businessProspectAnnual}</TableCell>
    <TableCell className="text-center">{row?.closedate}</TableCell>
    <TableCell className="text-center">{row?.executive}</TableCell>
