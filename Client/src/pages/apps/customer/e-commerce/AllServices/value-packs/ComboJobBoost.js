...
const ComboJobBoost = () => {
  ...
  useEffect(() => {
    const getService = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`${server}/api/combojobboostService/plans`);
  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await axios.put(`${server}/api/combojobboostService/update/${editId}`, requestData, {
        headers: {
          Accept: '*/*',
